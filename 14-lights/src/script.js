...
directionalLight.position.set(0.75, 1, 0)
...
//color, intensity, distance, angle, penumbra(edge), decay
const spotLight = new THREE.SpotLight(0x78ff99, 1, 6, Math.PI * 0.1, 0.25, 1)
spotLight.position.set(0,0.1,1)
scene.add(spotLight)
