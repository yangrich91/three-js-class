...
// ALWAYS NEED THIS FOR COLOR TEXTURES
...
roofColorTexture.repeat.set(0.3,0.4)
roofARMTexture.repeat.set(0.3,0.4)
roofNormalTexture.repeat.set(0.3,0.4)
...
const floor = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        //darkness of picture determines the heights, blacker is lower, lighter is higher
...
// bush1.scale.set(0.5, 0.5, 0.5) Scalar sets all values to 0.5
 ...
 * Fog
 */
scene.fog = new THREE.FogExp2('#04343f', 0.13)
